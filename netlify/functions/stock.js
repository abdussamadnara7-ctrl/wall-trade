...
const PSX_FUNDAMENTALS = {
  ...
  BAFL: {
    eps:'8.0 (annualised, quarterly EPS of 2.0 x4)', dps:'N/A',
    netMargin:'N/A', grossMargin:'N/A',
    roe:'N/A', roa:'N/A',
    revenue:'PKR 300B', netProfit:'N/A',
    totalAssets:'N/A', totalCash:'N/A',
    deposits:'N/A', advances:'N/A',
    investments:'N/A',
    casaRatio:'N/A', carRatio:'N/A',
    ...
    dividend:'N/A',
    aiSummary:'The document provided contains extremely limited financial data for BAFL, with only a revenue figure of PKR 300B and a quarterly EPS of 2.0 (annualised to 8.0) disclosed. The reporting period cannot be confirmed from the available text, and critical banking metrics such as net interest income, NPL ratio, CASA ratio, CAR, deposits, advances, and net profit are entirely absent. Without NII, provisioning, or balance sheet data, no meaningful assessment of NIM direction, asset quality trends, or funding mix can be made. No prior year comparative figures are available, making YoY analysis impossible. A complete quarterly report document is required to perform a thorough financial and credit quality analysis of Bank Alfalah Limited.',
    pe:'N/A', pb:'N/A', divYield:'N/A', fwdPe:'N/A',
    opMargin:'N/A', ebitdaMargin:'N/A', ebitda:'N/A',
